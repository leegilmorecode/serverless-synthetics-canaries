...
const loadBlueprint = async function (): Promise<void> {
    const urls = [process.env.WEBSITE_URL]; // this is where you add your webpages to check
...
const loadUrl = async function (page, urlPage): Promise<void> {
    let stepName = null;
    ...
    await synthetics.executeStep(stepName, async function (): Promise<void> {
